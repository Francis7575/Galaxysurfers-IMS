...
const Threejs = () => {
  ...
  const [newColor, setNewColor] = useState<string>('#808080');
  ...
  return (
    <section className='pb-4'>
        ...
        <div className='flex flex-col gap-4 930:flex-row 930:flex-wrap'>
          ...
          <div className='flex flex-col gap-4'>
            ...
            <input
              ...
              className='w-full h-full md:w-auto md:min-w-[200px] border border-black rounded-[7px] py-[10px] px-[10px] appearance-none cursor-pointer outline-none'
            />
          </div>
          <div className='flex flex-col gap-4'>
            <label className='text-black'>&nbsp;
      ...
      <div className='max-w-[300px] w-full md:max-w-[500px] 930:max-w-none mx-auto 930:mx-0 930:px-[29px] mt-3'>
        <div className='flex flex-col gap-4'>
          <button onClick={handleSave} className="w-full md:w-1/6 bg-blue hover:opacity-70 text-white font-bold py-2 px-4 rounded">SAVE</button>
        </div>
      </div>
    </section>
  );
