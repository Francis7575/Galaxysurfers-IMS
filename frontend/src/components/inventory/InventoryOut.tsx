...
const InventoryOutC = () => {
    ...
    const handleSubmit = async (e: FormEvent<HTMLFormElement>) => {
        ...
        try {
            ...
            const response = await fetch(`${import.meta.env.VITE_BACKEND_URL}/inventory/inventory-out`, {
                method: 'POST',
                headers: {
    ...
    return (
        ...
        <div className="font-manrope flex-1 w-full">
            <a onClick={navToInventoryMain}><Heading title="Inventory Out"/></a>
            ...
            <form onSubmit={handleSubmit} className='max-w-[300px] w-full md:max-w-[500px] 930:max-w-none mx-auto 930:mx-0 930:px-[29px]'>
                ...
                <button type="submit" className='bg-second-blue py-[8px] max-w-[232px] w-full text-white font-medium rounded-[.625rem]'>
                    Register
                </button>
                </div>
            </form>
