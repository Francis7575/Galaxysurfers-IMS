  ...
  return (
    <div className="font-manrope flex-1 w-full pb-8">
      ...
      <div className="flex justify-center 930:justify-start 930:pl-[29px] mt-[27px] mb-[17px] md:mb-[40px] 930:mt-[29px] 930:mb-[21px]">
        <button
          className="btn-styles relative hover:opacity-80 rounded-lg bg-deep-blue py-[10px] max-w-[222px] w-full font-medium text-dark-color"
          onClick={navToNewItem}
        >
          <p className="text-center 930:text-start 930:pl-8 text-white">Add New Item</p>
        </button>
      </div>
